...
The [provider-test](https://github.com/charlestai66/provider-test) repository can be
used as a starting point for new providers. For [terrajet](https://github.com/crossplane/terrajet)-based providers, the
[provider-jet-test](https://github.com/crossplane-contrib/provider-jet-test) is
available.
...
- [ ]  Code is licensed under the [Apache 2.0
  License](https://github.com/charlestai66/provider-test/blob/main/LICENSE)
...
- [ ]  Update
  [OWNERS.md](https://github.com/charlestai66/provider-test/blob/main/OWNERS.md)
...
- [ ]  Ensure `hack/boilerplate.go.txt` (used in Code generation) includes
  ...
  [https://github.com/charlestai66/provider-test/blob/main/hack/boilerplate.go.txt](https://github.com/charlestai66/provider-test/blob/main/hack/boilerplate.go.txt)
...
The [provider-test](https://github.com/charlestai66/provider-test)
...
- [ ] Create a [Crossplane
  ...
  configuration (see
  [package/crossplane.yaml)](https://github.com/charlestai66/provider-test/blob/main/package/crossplane.yaml)
...
- [ ] Utilize GitHub workflows from
  <https://github.com/charlestai66/provider-test/tree/main/.github/workflows>
...
- [ ] Enable Issues on your project and configure Issue tests (examples at:
  [.github/ISSUE_TEMPLATE](https://github.com/charlestai66/provider-test/tree/master/.github/ISSUE_TEMPLATE))
- [ ] Create Pull Request tests: (example:
  [PULL_REQUEST_TEMPLATE.md](https://github.com/charlestai66/provider-test/blob/master/.github/PULL_REQUEST_TEMPLATE.md))
